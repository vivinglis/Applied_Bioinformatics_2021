...
#write.table(spearman_corr, file = "new/1_spearman_corr_avgsnon_allel_sep.tsv")
write.table(spearman_corr, file = "new/1_spearman_corr_avgs_with_pro_non_allel_sep.tsv")
