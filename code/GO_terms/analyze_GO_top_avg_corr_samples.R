...
#Script to plot top GO terms separated by allel and tissue.
...
library("tidyverse")
# Read in tables
corr_avgs <- read.table("../../data_tables/GO_terms/1_data_for_corr_avg_and_std_GO_terms_filtered_4_avgs.tsv", header = TRUE) 
corr_avgs_pro <- read.table("../../data_tables/GO_terms/1_data_for_corr_avg_and_std_GO_terms_filtered_4_avgs_pro.tsv", header = TRUE) 
corr_reps <- read.table("../../data_tables/GO_terms/1_data_for_corr_avg_and_std_GO_terms_filtered_4_reps.tsv", header = TRUE) 
corr_reps_pro <- read.table("../../data_tables/GO_terms/1_data_for_corr_avg_and_std_GO_terms_filtered_4_reps_pro.tsv", header = TRUE) 
...
## ------------------------------- Start on analysing the GO term peptidyl.prolyl.cis.trans.isomerase.activity -------------------------
