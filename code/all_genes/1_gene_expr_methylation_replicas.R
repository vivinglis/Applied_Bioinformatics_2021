...
# Keep line 7 or 10 commented depending on want with pr without prmotor region.
...
write.table(pearson_corr, "1_pearson_corr_rep.tsv")
#write.table(pearson_corr, "1_pearson_corr_rep_with_pro.tsv")


# Not separated on Ba sa ------------------------------------------------------------------
# Keep line 70 or 73 commenetd depending on want with or without promotor region
...
write.table(pearson_corr, "1_pearson_corr_rep_non_allel_sep.tsv")
#write.table(pearson_corr, "1_pearson_corr_rep_with_pronon_allel_sep.tsv")
