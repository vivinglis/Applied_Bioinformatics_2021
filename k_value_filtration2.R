# del upp mellan sex och veg
# ta avg met for all 10 samples 
# distribution curve 
# dela upp gener mellan hög, låg, med methylation
# dela upp k value filtration after hög, låg, med 
...
df <- read.table("new/1_pearson_corr_avgs_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_pearson_corr_rep_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_spearman_corr_avgs_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_spearman_corr_rep_non_allel_sep.tsv", header = TRUE)

# Diff tables with promotor region, obs change met table to row 11. 
#df <- read.table("new/1_pearson_corr_avgs_with_pro_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_pearson_corr_rep_with_pro_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_spearman_corr_avgs_with_pro_non_allel_sep.tsv", header = TRUE)
#df <- read.table("new/1_spearman_corr_rep_with_pro_non_allel_sep.tsv", header = TRUE)
